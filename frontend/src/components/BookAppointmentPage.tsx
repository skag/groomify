...
import { Search, ChevronLeft, ChevronRight, Dog, ArrowLeft } from "lucide-react"
...
export function BookAppointmentPage({ preSelectedPet }: BookAppointmentPageProps) {
        ...
        <div className="p-6 h-full overflow-auto">
          <div className="max-w-2xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold">Select a Pet</h1>
            </div>
